...
local Window = OrionLib:MakeWindow({Name = "Kroy hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Kroy hub"})

OrionLib:MakeNotification({
	Name = "Kroy hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://125004290891749",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://125004290891749",
    PremiumOnly = false
})
